...
export const ACCOUNT_STATUS = Object.freeze({ REGISTRATION: "REGISTRATION", PENDING: "PENDING_APPROVAL", ACTIVE: "ACTIVE", SUSPENDED: "SUSPENDED" });
...
const userSchema = new mongoose.Schema({
  ...
  accountStatus: { type: String, enum: Object.values(ACCOUNT_STATUS), default: ACCOUNT_STATUS.REGISTRATION, required: true, index: true },
  ...
  phoneLookupHash: { type: String, unique: true, sparse: true, select: false },
